...
namespace Xiyu.DeepSeekApi.ChatHandler
{
    ...
    public sealed class DeepseekReasoner : ChatProcessor
    {
        ...
        public DeepseekReasoner(string apiKey, IRequestBody requestBody, TimeSpan timeOut, MessageCollector messageCollector = null) : base(apiKey, requestBody, messageCollector)
        {
            TimeOut = timeOut;
        }
