...
namespace Xiyu.DeepSeekApi.Response.Stream
{
    public class StreamChatResult
    {
        ...
        [JsonConstructor]
        public StreamChatResult(string id, List<StreamChoice> choices, int created, ModelType model, string systemFingerprint, string chatObject, Usage? usage)
        {
            Id = id;
            Choices = choices;
            Created = created;
        ...
        public List<StreamChoice> Choices { get; }
        ...
        public Message GetMessage() => Choices[0].DeltaMessage;
    }
}